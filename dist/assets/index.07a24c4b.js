 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class HU{constructor(e){this.app=e}_delete(){return delete Mo[this.app.options.appId],Promise.resolve()}}let Mo={},Sy=[];const ky={};let Rh="dataLayer",WU="gtag",Ay,wT,Ry=!1;function zU(){const t=[];if(zb()&&t.push("This is a browser extension environment."),fO()||t.push("Cookies are not available."),t.length>0){const e=t.map((s,i)=>`(${i+1}) ${s}`).join(" "),n=Zt.create("invalid-analytics-context",{errorInfo:e});zt.warn(n.message)}}function qU(t,e,n){zU();const s=t.options.appId;if(!s)throw Zt.create("no-app-id");if(!t.options.apiKey)if(t.options.measurementId)zt.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${t.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw Zt.create("no-api-key");if(Mo[s]!=null)throw Zt.create("already-exists",{id:s});if(!Ry){CU(Rh);const{wrappedGtag:r,gtagCore:o}=RU(Mo,Sy,ky,Rh,WU);wT=r,Ay=o,Ry=!0}return Mo[s]=jU(t,Sy,ky,e,Ay,Rh,n),new HU(t)}function KU(t=au()){t=mt(t);const e=Ui(t,Ic);return e.isInitialized()?e.getImmediate():GU(t)}function GU(t,e={}){const n=Ui(t,Ic);if(n.isInitialized()){const i=n.getImmediate();if(na(e,n.getOptions()))return i;throw Zt.create("already-initialized")}return n.initialize({options:e})}function YU(t,e,n,s){t=mt(t),VU(wT,Mo[t.app.options.appId],e,n,s).catch(i=>zt.error(i))}const Ny="@firebase/analytics",Oy="0.9.5";function QU(){Kt(new Vt(Ic,(e,{options:n})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("installations-internal").getImmediate();return qU(s,i,n)},"PUBLIC")),Kt(new Vt("analytics-internal",t,"PRIVATE")),bt(Ny,Oy),bt(Ny,Oy,"esm2017");function t(e){try{const n=e.getProvider(Ic).getImmediate();return{logEvent:(s,i,r)=>YU(n,s,i,r)}}catch(n){throw Zt.create("interop-component-reg-failed",{reason:n})}}}QU();const XU={apiKey:"AIzaSyDTIda0nsAIldkPNk6vRoL7IPse4L7NVMg",authDomain:"listify-v2.firebaseapp.com",projectId:"listify-v2",storageBucket:"listify-v2.appspot.com",messagingSenderId:"927463433227",appId:"1:927463433227:web:a0d94a59566a8b16d2930e",measurementId:"G-30WR1BN041"},Bu=Zb(XU);KU(Bu);const AW=$I(Bu),JU=rp(Bu);function ZU(){return new Promise((t,e)=>{const n=yD(JU,s=>{n(),t(s)},e)})}const eV=[{path:"/",component:eO,children:[{path:"",name:"Home",component:()=>vs(()=>import("./Home.f78ca6c2.js"),["assets/Home.f78ca6c2.js","assets/lists.cc87a0fc.js","assets/lists.f7bfd9e0.css","assets/forwardRefs.2d67e586.js","assets/VOverlay.132c43e5.js","assets/easing.6e2d7abd.js","assets/VOverlay.2c01b8e6.css","assets/VContainer.46ada41a.js","assets/VContainer.37f80755.css","assets/Home.ea0fcff1.css"]),meta:{requiresAuth:!0}},{path:"/timer",name:"Timer",component:()=>vs(()=>import("./Timer.0ad7c0ba.js"),["assets/Timer.0ad7c0ba.js","assets/VContainer.46ada41a.js","assets/VContainer.37f80755.css"]),meta:{requiresAuth:!0}},{path:"/settings",name:"Settings",component:()=>vs(()=>import("./Settings.81882252.js"),["assets/Settings.81882252.js","assets/VContainer.46ada41a.js","assets/VContainer.37f80755.css","assets/VForm.6439e8c7.js","assets/form.0657a469.js","assets/forwardRefs.2d67e586.js","assets/Settings.7d76e4a4.css"]),meta:{requiresAuth:!0}},{path:"/list",name:"List",component:()=>vs(()=>import("./List.eea96530.js"),["assets/List.eea96530.js","assets/lists.cc87a0fc.js","assets/lists.f7bfd9e0.css","assets/VTextField.cf83acd0.js","assets/easing.6e2d7abd.js","assets/form.0657a469.js","assets/forwardRefs.2d67e586.js","assets/VTextField.f91f0908.css","assets/VContainer.46ada41a.js","assets/VContainer.37f80755.css","assets/List.d720ec69.css"]),meta:{requiresAuth:!0},children:[{path:":id",component:()=>vs(()=>import("./List.eea96530.js"),["assets/List.eea96530.js","assets/lists.cc87a0fc.js","assets/lists.f7bfd9e0.css","assets/VTextField.cf83acd0.js","assets/easing.6e2d7abd.js","assets/form.0657a469.js","assets/forwardRefs.2d67e586.js","assets/VTextField.f91f0908.css","assets/VContainer.46ada41a.js","assets/VContainer.37f80755.css","assets/List.d720ec69.css"])}]},{path:"/login",name:"Login",component:()=>vs(()=>import("./Login.099724e5.js"),["assets/Login.099724e5.js","assets/persist.453431d7.js","assets/VTextField.cf83acd0.js","assets/easing.6e2d7abd.js","assets/form.0657a469.js","assets/forwardRefs.2d67e586.js","assets/VTextField.f91f0908.css","assets/persist.53f56c42.css","assets/VContainer.46ada41a.js","assets/VContainer.37f80755.css","assets/VForm.6439e8c7.js","assets/VOverlay.132c43e5.js","assets/VOverlay.2c01b8e6.css","assets/Login.31f1c9b5.css"])},{path:"/signup",name:"Registration",component:()=>vs(()=>import("./Register.30c6565e.js"),["assets/Register.30c6565e.js","assets/persist.453431d7.js","assets/VTextField.cf83acd0.js","assets/easing.6e2d7abd.js","assets/form.0657a469.js","assets/forwardRefs.2d67e586.js","assets/VTextField.f91f0908.css","assets/persist.53f56c42.css","assets/VContainer.46ada41a.js","assets/VContainer.37f80755.css","assets/VForm.6439e8c7.js","assets/Register.6165d82d.css"])}]}],bT=VN({history:nN({}.BASE_URL),routes:eV});bT.beforeEach(async t=>{if(t.matched.some(n=>n.meta.requiresAuth)&&!await ZU())return"/login"});function tV(t){_A(),t.use($R).use(NR).use(bT)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $H="storage";function UH(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),s=t.getProvider("auth-internal"),i=t.getProvider("app-check-internal");return new FH(n,s,i,e,Vi)}function VH(){Kt(new Vt($H,UH,"PUBLIC").setMultipleInstances(!0)),bt(w_,b_,""),bt(w_,b_,"esm2017")}VH();function NW(t){return $I(ju(t))}function BH(t){return(e,n)=>{const s=kV(e,n).run(()=>J(t));TT.set(e,s),RV(s,e)}}function OW(t){return SV?rp(ju(t)):null}function jH(t,{firebaseApp:e,modules:n=[]}){t.provide(IT,e);for(const s of n)t.use(s.bind(null,e))}const Ig=pA(mA);Ig.use(jH,{firebaseApp:Bu,modules:[BH()]});tV(Ig);Ig.mount("#app");export{nt as $,jr as A,Ws as B,nu as C,Er as D,Br as E,Sa as F,Uf as G,Hr as H,Ms as I,zs as J,gW as K,Ur as L,ul as M,J as N,XH as O,Ow as P,ZH as Q,Ii as R,Ia as S,Hs as T,Le as U,Rs as V,Wt as W,Ye as X,js as Y,vn as Z,es as _,An as a,pm as a$,lr as a0,WC as a1,E1 as a2,Fr as a3,Je as a4,ur as a5,Mn as a6,x1 as a7,q1 as a8,Kg as a9,Lb as aA,p1 as aB,Pb as aC,Cf as aD,pb as aE,hW as aF,R_ as aG,uf as aH,Bc as aI,Pe as aJ,kW as aK,rp as aL,FR as aM,yD as aN,un as aO,ba as aP,Bs as aQ,JH as aR,nn as aS,Uc as aT,aW as aU,Uw as aV,xw as aW,OA as aX,sW as aY,iW as aZ,rW as a_,o1 as aa,xf as ab,xb as ac,m1 as ad,jf as ae,Db as af,v1 as ag,lW as ah,Bf as ai,ub as aj,If as ak,Mi as al,RW as am,YH as an,zH as ao,_t as ap,zN as aq,XN as ar,lb as as,SW as at,TW as au,IW as av,AW as aw,nv as ax,Ob as ay,f1 as az,I as b,oW as b0,SA as b1,ZA as b2,Nt as b3,ce as b4,YN as b5,Xc as b6,y1 as b7,KH as b8,GH as b9,yW as bA,ow as bB,HH as bC,WH as bD,vW as bE,wW as bF,dW as ba,OW as bb,_W as bc,cr as bd,rw as be,qH as bf,QH as bg,Nw as bh,eW as bi,CA as bj,kn as bk,NW as bl,nA as bm,CW as bn,$i as bo,dm as bp,uW as bq,tW as br,cW as bs,GN as bt,Ls as bu,nW as bv,EW as bw,JU as bx,Es as by,bW as bz,b as c,ve as d,ut as e,Ta as f,Ke as g,mW as h,Me as i,fn as j,R1 as k,I1 as l,Fi as m,tu as n,HN as o,zn as p,fW as q,D1 as r,pW as s,it as t,Ql as u,hA as v,Hl as w,Vr as x,Ca as y,$f as z};
