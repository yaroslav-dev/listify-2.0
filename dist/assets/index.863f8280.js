 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class HU{constructor(e){this.app=e}_delete(){return delete Mo[this.app.options.appId],Promise.resolve()}}let Mo={},Sy=[];const ky={};let Rh="dataLayer",WU="gtag",Ay,wT,Ry=!1;function zU(){const t=[];if(zb()&&t.push("This is a browser extension environment."),fO()||t.push("Cookies are not available."),t.length>0){const e=t.map((s,i)=>`(${i+1}) ${s}`).join(" "),n=Zt.create("invalid-analytics-context",{errorInfo:e});zt.warn(n.message)}}function qU(t,e,n){zU();const s=t.options.appId;if(!s)throw Zt.create("no-app-id");if(!t.options.apiKey)if(t.options.measurementId)zt.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${t.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw Zt.create("no-api-key");if(Mo[s]!=null)throw Zt.create("already-exists",{id:s});if(!Ry){CU(Rh);const{wrappedGtag:r,gtagCore:o}=RU(Mo,Sy,ky,Rh,WU);wT=r,Ay=o,Ry=!0}return Mo[s]=jU(t,Sy,ky,e,Ay,Rh,n),new HU(t)}function KU(t=au()){t=mt(t);const e=Ui(t,Ic);return e.isInitialized()?e.getImmediate():GU(t)}function GU(t,e={}){const n=Ui(t,Ic);if(n.isInitialized()){const i=n.getImmediate();if(na(e,n.getOptions()))return i;throw Zt.create("already-initialized")}return n.initialize({options:e})}function YU(t,e,n,s){t=mt(t),VU(wT,Mo[t.app.options.appId],e,n,s).catch(i=>zt.error(i))}const Ny="@firebase/analytics",Oy="0.9.5";function QU(){Kt(new Vt(Ic,(e,{options:n})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("installations-internal").getImmediate();return qU(s,i,n)},"PUBLIC")),Kt(new Vt("analytics-internal",t,"PRIVATE")),bt(Ny,Oy),bt(Ny,Oy,"esm2017");function t(e){try{const n=e.getProvider(Ic).getImmediate();return{logEvent:(s,i,r)=>YU(n,s,i,r)}}catch(n){throw Zt.create("interop-component-reg-failed",{reason:n})}}}QU();const XU={apiKey:"AIzaSyDTIda0nsAIldkPNk6vRoL7IPse4L7NVMg",authDomain:"listify-v2.firebaseapp.com",projectId:"listify-v2",storageBucket:"listify-v2.appspot.com",messagingSenderId:"927463433227",appId:"1:927463433227:web:a0d94a59566a8b16d2930e",measurementId:"G-30WR1BN041"},Bu=Zb(XU);KU(Bu);const AW=$I(Bu),JU=rp(Bu);function ZU(){return new Promise((t,e)=>{const n=yD(JU,s=>{n(),t(s)},e)})}const eV=[{path:"/",component:eO,children:[{path:"",name:"Home",component:()=>vs(()=>import("./Home.3790b875.js"),["assets/Home.3790b875.js","assets/lists.5d7629cd.js","assets/lists.f7bfd9e0.css","assets/forwardRefs.2d67e586.js","assets/easing.6e2d7abd.js","assets/VContainer.a55ccc89.js","assets/VContainer.37f80755.css","assets/Home.dd89616e.css"]),meta:{requiresAuth:!0}},{path:"/timer",name:"Timer",component:()=>vs(()=>import("./Timer.a7021700.js"),["assets/Timer.a7021700.js","assets/VContainer.a55ccc89.js","assets/VContainer.37f80755.css"]),meta:{requiresAuth:!0}},{path:"/settings",name:"Settings",component:()=>vs(()=>import("./Settings.61cedd6f.js"),["assets/Settings.61cedd6f.js","assets/VContainer.a55ccc89.js","assets/VContainer.37f80755.css","assets/VForm.1dc21280.js","assets/form.97b37081.js","assets/forwardRefs.2d67e586.js","assets/Settings.7d76e4a4.css"]),meta:{requiresAuth:!0}},{path:"/list",name:"List",component:()=>vs(()=>import("./List.ba0d36c9.js"),["assets/List.ba0d36c9.js","assets/lists.5d7629cd.js","assets/lists.f7bfd9e0.css","assets/VTextField.2c0f9798.js","assets/easing.6e2d7abd.js","assets/form.97b37081.js","assets/forwardRefs.2d67e586.js","assets/VTextField.f91f0908.css","assets/VContainer.a55ccc89.js","assets/VContainer.37f80755.css","assets/List.d720ec69.css"]),meta:{requiresAuth:!0},children:[{path:":id",component:()=>vs(()=>import("./List.ba0d36c9.js"),["assets/List.ba0d36c9.js","assets/lists.5d7629cd.js","assets/lists.f7bfd9e0.css","assets/VTextField.2c0f9798.js","assets/easing.6e2d7abd.js","assets/form.97b37081.js","assets/forwardRefs.2d67e586.js","assets/VTextField.f91f0908.css","assets/VContainer.a55ccc89.js","assets/VContainer.37f80755.css","assets/List.d720ec69.css"])}]},{path:"/login",name:"Login",component:()=>vs(()=>import("./Login.fee3a3cf.js"),["assets/Login.fee3a3cf.js","assets/persist.cdaadb22.js","assets/VTextField.2c0f9798.js","assets/easing.6e2d7abd.js","assets/form.97b37081.js","assets/forwardRefs.2d67e586.js","assets/VTextField.f91f0908.css","assets/persist.53f56c42.css","assets/VContainer.a55ccc89.js","assets/VContainer.37f80755.css","assets/VForm.1dc21280.js","assets/Login.9cbfb8a7.css"])},{path:"/signup",name:"Registration",component:()=>vs(()=>import("./Register.462a5f13.js"),["assets/Register.462a5f13.js","assets/persist.cdaadb22.js","assets/VTextField.2c0f9798.js","assets/easing.6e2d7abd.js","assets/form.97b37081.js","assets/forwardRefs.2d67e586.js","assets/VTextField.f91f0908.css","assets/persist.53f56c42.css","assets/VContainer.a55ccc89.js","assets/VContainer.37f80755.css","assets/VForm.1dc21280.js","assets/Register.7719a80e.css"])}]}],bT=VN({history:nN({}.BASE_URL),routes:eV});bT.beforeEach(async t=>{if(t.matched.some(n=>n.meta.requiresAuth)&&!await ZU())return console.log("yes"),"/login";console.log("no")});function tV(t){_A(),t.use($R).use(NR).use(bT)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
